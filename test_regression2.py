...
# Let's adjust the lengths so that the parent is NOT decomposed during the `a` decomposition step (length > 500)
long_text = "This is highly relevant valid content that we absolutely need to keep. " * 10
